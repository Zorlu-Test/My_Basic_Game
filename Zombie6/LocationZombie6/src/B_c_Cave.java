public class B_c_Cave extends B_a_Battle_Location{
    String location="Cave";
    public B_c_Cave(Player player) {
        super(player);
    ...
    public void print_Location_Greting() {
        System.out.println("You are in the Cave! How dare you come there alone ? Now you must fight with us !");
