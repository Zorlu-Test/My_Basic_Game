public class B_b_Forest extends B_a_Battle_Location {

    String location = "Forest";

    public B_b_Forest(Player player) {
        super(player);
    ...
    public void print_Location_Greting() {
        ...
        System.out.println("You are in the Forest! How dare you come there alone ? Now you must fight with us !");
